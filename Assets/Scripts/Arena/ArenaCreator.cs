    ...
    void CreateMap()
    {
        ...
        for (int r = 0; r < row; r++)
        {
            for (int c = 0; c < column; c++)
            {
                ...
                arenaCell.position = startPosition + new Vector2(c * 2, r * -2);
                arena[r, c] = arenaCell;
            }
        }
    }
        ...
        for (int r = 0; r < row; r++)
        {
            for (int c = 0; c < column; c++)
            {
                ...
                else
                {
                    ...
                    {
                        childObject = PhotonNetwork.Instantiate("Wall", arena[r, c].position + Vector2.down, Quaternion.identity);
                    ...
                    {
                        childObject = PhotonNetwork.Instantiate("Wall", arena[r, c].position + Vector2.right, Quaternion.Euler(0, 0, 90));
